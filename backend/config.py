...
LABEL_REVIEW_HIGHLIGHT_CHECKPOINT = (
    Path(_LABEL_REVIEW_HIGHLIGHT_CHECKPOINT).expanduser()
    if _LABEL_REVIEW_HIGHLIGHT_CHECKPOINT
    else VIDEOMAE_HIGHLIGHT_CHECKPOINT
)
